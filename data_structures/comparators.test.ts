...
test("ascend() works as expected", () => {
  ...
  assert.strictEqual(ascend(new Date("2020-05-19"), new Date("2020-05-20")), -1);
...
test("descend() works as expected", () => {
  ...
  assert.strictEqual(descend(new Date("2020-05-20"), new Date("2020-05-20")), 0);
  assert.strictEqual(descend(new Date("2020-05-19"), new Date("2020-05-20")), 1);
  assert.strictEqual(descend(new Date("2020-05-20"), new Date("2020-05-19")), -1);
